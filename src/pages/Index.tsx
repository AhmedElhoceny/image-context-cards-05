    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          {/* Left Section - Quick Actions and Report Calendar (3/5 width) */}
          ...
          {/* Right Section - Rep Activities (2/5 width) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Left Section - Client Access and Report Calendar (2/3 width) */}
          ...
          {/* Right Section - Empty for now (1/3 width) */}
